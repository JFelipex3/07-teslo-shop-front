...
export const AdminProductForm = ({ title, subTitle, product }: Props) => {
  ...
  const addTag = () => {
    const newTag = labelInputRefTag.current!.value.trim();
    ...
    labelInputRefTag.current!.value = '';
  };

  const removeTag = (tagToRemove: string) => {
    setValue('tags', getValues('tags').filter((tag) => tag !== tagToRemove));
  };
