                        ...
                        <div className="flex items-center space-x-4">
                            <div className="hidden md:flex items-center space-x-2">
                                <div className="relative">
                                    ...
                                    <Input ref={inputRef} placeholder="Buscar productos..." className="pl-9 w-64 h-9 bg-white" onKeyDown={handleSearch} defaultValue={query} />
                                </div>
                            </div>
...

                            {
                                !user ? (
                                    ...
                                    <Button variant="outline" size="sm" className="ml-2" onClick={ logout }>Cerrar sesión</Button>
                                )
                            }
